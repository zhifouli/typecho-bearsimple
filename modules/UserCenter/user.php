...
<label class="typecho-label">
您的个性签名</label>
<input id="usersignature" name="signature" type="text" class="text" value="<?php if($this->user->signature == 0):?>这个人太懒了，没有留下个性签名<?php else:?><?php echo $this->user->signature; ?><?php endif; ?>" />
<p class="description">
请填入您的个性签名</p>
</li>
</ul>
...
<?php if(Bsoptions('Emoji') == true) :?>
 ...
 <div  class="ignore emoemo" style="margin-top:-30px;margin-bottom:10px"></div>
 <?php endif; ?>
