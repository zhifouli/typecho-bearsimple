...
<?php endif; ?>
 <div class="page-card">
   ...
   <?php while($this->next()): ?>
 <a class="album" href="<?php $this->permalink() ?>">
        <img <?php echo lazyload('1'); ?>src="<?php echo thumb2($this,'album'); ?>" alt="相册" class="album-cover">
        <div class="album-info">
            <h3 class="album-title"><?php echo $this->title ?></h3>
        </div>
    </a>
