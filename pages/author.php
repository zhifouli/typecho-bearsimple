<?php $loader = Bsoptions('Lazyload_style');?>
...
<div class="pure-g" id="layout">
  ...
  <div class="post_author-avatar"><img alt="<?php echo $this->getArchiveTitle(); ?>" src="<?php echo imgravatarq(getAuthorInfo($this->getArchiveSlug(),'mail')); ?>" loading="lazy"></div>
  ...
  <p class="post_author-bio"> <?php if(getAuthorInfo($this->getArchiveSlug(),'person_Signature') == 0):?>这个人太懒了，没有留下个性签名<?php else:?><?php echo getAuthorInfo($this->getArchiveSlug(),'signature'); ?><?php endif; ?></p></div></div>

<div class="page-card">
<div class="ui secondary menu wrapped" id="uitab">
...
content2(json.list);
                    ...
                    var html = "<center><div class=\"ui labels\"><a class=\"ui label\" data-page="+ sayspage +">共" + saysn + "条</a><a class=\"ui label\" data-page="+ sayspage +">第" + sayspage + "/" + saysmax + "页</a>";
