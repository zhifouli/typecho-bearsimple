...
<div class="article-header">
  ...
  <?php if(Bsoptions('Poster') == true): ?> <button class="bear-share-poster j-bwqr-poster-btn" data-cid="<?php echo $this->cid;?>" id="poster-btn"><i class="fas fa-newspaper"></i> 生成海报</button><?php endif; ?>
  <button id="editbtn" style="display:none;" onclick="window.open('<?php $this->options->adminUrl('/write-page.php?cid='.$this->cid); ?>','_self')"><i class="pencil icon"></i>编辑</button>
</div>
  </div>
</div>
