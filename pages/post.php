...
<script src="<?php AssetsDir();?>assets/js/article_donate.js?v=<?php echo themeVersion(); ?>"></script>
<?php endif;?>
      ...
      <div class="pure-u-1 pure-u-md-<?php if(Bsoptions('site_style') == '1' || Bsoptions('site_style') == ''):?>3<?php endif;?><?php if(Bsoptions('site_style') == '2'):?>4<?php endif;?>-4">
         ...
         <div id="bearsimple-scroll">
          ...
          <article class="post">
              ...
              <div class="ui basic pointing below big label" style="letter-spacing:1px;line-height:1.23;">
  <i class="bullhorn icon"></i><?php $this->fields->articleplonr() ?>
</div>
              <?php endif; ?>
...
<div class="article-header">
  ...
  <div class="article-meta">
    ...
    <?php if($this->fields->Hot == '1'): ?>
    <span class="meta-item">
      <i class="fas fa-eye" data-scid="<?php echo $this->cid; ?>"></i>
      热度: <hot id="ahot"></hot>°C
    </span>
    <?php endif; ?>
  ...
  <div class="article-actions">
    <button class="action-btn" id="toggle-menu">
      <i class="fas fa-cog"></i> 选项
    </button>
   <div class="dropdown-menu" id="dropdown-menu">
  <button id="article_change_m"><i class="fas fa-font"></i> 默认字体 <span class="checkmark">✓</span></button>
  <button id="article_change_k"><i class="fas fa-font"></i> 楷体 <span class="checkmark">✓</span></button>
  <button id="article_change_xlwk"><i class="fas fa-font"></i> 霞鹜文楷体 <span class="checkmark">✓</span></button>
  <div class="divider"></div>
  <button id="text-size-small"><i class="fas fa-text-height"></i> 小 <span class="checkmark">✓</span></button>
  ...
  <button id="text-size-large"><i class="fas fa-text-height"></i> 大 <span class="checkmark">✓</span></button>
   <?php if(Bsoptions('Readmode') == true || Bsoptions('Poster') == true): ?> 
     <div class="divider"></div>
     <?php endif;?>
  <?php if(Bsoptions('Readmode') == true): ?><button id="toggle-reading-mode"><i class="fas fa-book"></i> 阅读模式</button><?php endif;?>
  <?php if(Bsoptions('Poster') == true): ?><button onclick="generatePoster()"><i class="fas fa-newspaper"></i> 生成海报</button><?php endif; ?>
  <button id="editbtn" style="display:none;" onclick="window.open('<?php $this->options->adminUrl('/write-post.php?cid='.$this->cid); ?>','_self')"><i class="pencil icon"></i>编辑</button>
</div>
  </div>
</div>


<?php $this->need('modules/tools.php'); ?>
...
<div class="article-navigation">
  <!-- 上一篇 -->
  <span href="" class="nav-link prev-link">
    <i class="fas fa-chevron-left"></i>
    <span class="nav-text"><?php $this->thePrev('%s','没有了'); ?></span>
  </span>

  <!-- 下一篇 -->
  <span href="" class="nav-link next-link">
    <span class="nav-text"><?php $this->theNext('%s','没有了'); ?></span>
...
<?php $this->need('modules/poster.php'); ?>
<?php endif; ?>
...
<div class="recommended-articles">
  ...
  <div class="article-masonry">
    ...
    <?php if(!$this->hidden): ?>
    <?php if(Bsoptions('CommentClose_Hide') == '' || Bsoptions('CommentClose_Hide') == false): ?> 
<?php if(Bsoptions('comment_choose') == '' || Bsoptions('comment_choose') == '1'): ?>    

    <?php $this->need('comments.php'); ?>
    <?php else:?>

    <?php $this->need('thirdparty_comments.php'); ?>
