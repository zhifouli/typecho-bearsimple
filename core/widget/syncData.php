...
break;
case "openHot":
             $db->query($db->update('table.fields')->where('name = ?', 'Hot')->rows(array('str_value' =>"1")));
 $result = array(
    'code' => 1,
    'msg' => '同步成功'
);
...
case "closeHot":
             $db->query($db->update('table.fields')->where('name = ?', 'Hot')->rows(array('str_value' =>"2")));
 $result = array(
    'code' => 1,
    'msg' => '同步成功'
);
break;
case "openTag":
             $db->query($db->update('table.fields')->where('name = ?', 'tags')->rows(array('str_value' =>"1")));
 $result = array(
    'code' => 1,
    'msg' => '同步成功'
);
...
case "closeTag":
             $db->query($db->update('table.fields')->where('name = ?', 'tags')->rows(array('str_value' =>"2")));
 $result = array(
    'code' => 1,
    'msg' => '同步成功'
);
