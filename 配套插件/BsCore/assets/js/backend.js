...
const driverObj = driver({
  ...
  steps: [
    ...
    { element: '#wpwrap li:nth-child(9)', popover: { title: '这里是加载设置', description: '加载设置中包含Pjax、图片懒加载、HTML压缩等功能', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(10)', popover: { title: '这里是行为验证', description: '行为验证支持了对网站评论、友链提交等进行验证，支持了多种行为验证方式', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(11)', popover: { title: '这里是存储设置', description: '通过存储设置您可以将腾讯云COS、阿里云OSS等作为网站的存储方式', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(12)', popover: { title: '这里是缓存设置', description: '通过缓存设置可以加快您的站点访问速度，支持了多种缓存方式', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(13)', popover: { title: '这里是SEO管理', description: 'SEO管理中集成了Sitemap地图生成、收录推送等功能，方便您更快更有效率的优化网站SEO', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(14)', popover: { title: '这里是模块管理', description: '这里包含了文章优化、Memos、微语等多个模块，一些独立页面的创建过程也需要这里的参与', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(15)', popover: { title: '这里是用户中心设置', description: '本主题的用户中心目前包含了投稿、发动态等功能，可以通过本设置对用户中心进行设置与管理', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(16)', popover: { title: '这里是打赏设置', description: '您可以在这里添加打赏方式，它将显示在文章页面', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(17)', popover: { title: '这里是评论设置', description: '评论设置中可以操作电邮通知、评论过滤等功能，便于您对网站的评论进行统一管理', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(18)', popover: { title: '这里是SMTP设置', description: 'SMTP设置统一控制了网站的电邮通知通道，所有电邮通知都需要这里进行配合参与，若要用到需进行电邮通知的功能，都请先在这里填写好相关信息', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(19)', popover: { title: '这里是文章设置', description: '您可以在这里对文章组件进行设置，如第三方分享、文章目录树等功能也是在这里哦', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(20)', popover: { title: '这里是图片设置', description: '图片设置主要对网站图片进行控制，如添加水印等', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(21)', popover: { title: '这里是海报设置', description: '您可以通过该功能开启文章海报分享，访客可以保存海报分享给别人', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(22)', popover: { title: '这里是区块设置', description: '区块设置中包含了对侧边栏和广告等区块的管理', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(23)', popover: { title: '这里是博主信息设置', description: '您可以在这里添加您的个人信息，便于访客能够进一步认识您', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(24)', popover: { title: '这里是其他设置', description: '其他设置中包含了日夜切换、语言切换等功能，若在其他地方没找到的功能不妨来这里找找', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(25)', popover: { title: '这里是实验室', description: '实验室主要包含仍处于实验阶段或仍会进行大幅度调整的功能', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(26)', popover: { title: '这里是短代码', description: '您可以通过这里了解目前主题支持的所有短代码', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(27)', popover: { title: '这里是数据备份', description: '在进行升级操作或其他关键性操作时可先通过数据备份将备份文件下载到本地，防止因一些意外状况导致主题设置丢失', side: "left", align: 'start' }},
    { element: '#wpwrap li:nth-child(28)', popover: { title: '这里是在线升级', description: '您可以通过这里对主题进行在线升级操作，免去一些繁琐性操作', side: "left", align: 'start' }},
...
$(document).delegate(".ui.yellow.icon.label.edit", "click", function() {
    if ($(this).data('checkurl') === undefined || $(this).data('checkurl') === "") {
    $(this).data('checkurl', '暂无');
}
layer.open({
    type: 1 
    ,btn:["确定修改","取消修改"]
    ,title: '修改友链'
    ,skin: 'layui-layer-prompt'
    ,content: "<div style='margin:-10px 0 10px 0'>友链ID</div><div><input id='friendid' type='text' class='layui-layer-input' value="+$(this).attr('data-id')+" placeholder='友链ID' disabled></div><div style='margin:10px 0 10px 0'>友链网址</div><div><input style='margin-top:10px;' id='friendurl' type='text' class='layui-layer-input' value="+$(this).attr('data-friendurl')+" placeholder='友链网址'></div><div style='margin:10px 0 10px 0'>友链名称</div><div><textarea style='width:100%' id='friendname' type='text' class='layui-layer-textarea' placeholder='友链名称'>"+$(this).attr('data-friendname')+"</textarea></div><div style='margin:10px 0 10px 0'>友链图标</div><div><input style='margin-top:10px;' id='friendpic' type='text' class='layui-layer-input' value="+$(this).attr('data-friendpic')+" placeholder='友链图标'></div><div style='margin:10px 0 10px 0'>友链描述</div><div><input style='margin-top:10px;' id='frienddec' type='text' class='layui-layer-input' value="+$(this).attr('data-frienddec')+" placeholder='友链描述'></div><div style='margin:10px 0 10px 0'>联系邮箱</div><div><input style='margin-top:10px;' id='contactmail' type='text' class='layui-layer-input' value="+$(this).attr('data-mail')+" placeholder='联系邮箱'></div><div style='margin:10px 0 10px 0'>该站点的友链放置页面网址</div><div><input style='margin-top:10px;' id='checkurl' type='text' class='layui-layer-input' value="+$(this).data('checkurl')+" placeholder='该站点的友链放置页面网址'></div><div style='margin:10px 0 10px 0'>友链状态</div><div><input style='margin-top:10px;' id='status' type='text' class='layui-layer-input' value="+$(this).attr('data-status')+" placeholder='友链状态' disabled></div><div style='margin:10px 0 10px 0'>驳回原因</div><div><textarea style='width:100%' id='rejectreason' class='layui-layer-textarea'  placeholder='在友链为已驳回状态时可在此项填写驳回原因'>"+$(this).attr('data-rejectreason')+"</textarea></div>"
    ,yes: function(index, callback){
        if(!$(callback).find("#friendname").val()){
            layer.msg('友链名称不能为空哦~');
            return false;
