...
if (!function_exists('enqueue_script_helper')) {
    ...
    function enqueue_script_helper($script_name, $src = '', $ret = true)
    {
        ...
        if ($src) {
            ...
            if (!$ret) {
                echo '<script type="text/javascript" src="' . CSF::include_plugin_url2('assets/js/' . $script_name . '.min.js') . '"></script>';
                return '';
            }
            return '<script type="text/javascript" src="' . CSF::include_plugin_url2('assets/js/' . $script_name . '.min.js') . '"></script>';
        }
...
if (!function_exists('enqueue_style_helper')) {
    function enqueue_style_helper($style_name, $src = '', $ret = true)
    {
        ...
        if ($src) {
            ...
            if (!$ret) {
                echo '<script id="' . $style_name . '" type="text/javascript" src="' . CSF::include_plugin_url2('assets/js/' . $style_path_name . '.min.js') . '"></script>';
                return '';
            }
            return '<script id="' . $style_name . '" type="text/javascript" src="' . CSF::include_plugin_url2('assets/js/' . $style_path_name . '.min.js') . '"></script>';
        }
