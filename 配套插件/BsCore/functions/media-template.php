...
if (!function_exists('wp_print_media_templates')) {
    function wp_print_media_templates()
    {
        ...
        <script src="//lf6-cdn-tos.bytecdntp.com/cdn/expire-1-M/clipboard.js/2.0.10/clipboard.min.js"
                type="application/javascript"></script>
        <script src="<?php $options->pluginUrl('BsCore/assets/js/moxie.js'); ?>"></script>
        <script src="<?php $options->pluginUrl('BsCore/assets/js/plupload.js'); ?>"></script>
...
var date = new Date();
      ...
      var fullDate = year+'年'+month+'月'+strDate+'日';
                    ...
                    var html = `<li tabindex="0" role="checkbox" aria-label="bsphoto" aria-checked="true" data-name="${data.title}" data-date="${fullDate}" data-id="${id}"  data-edit="<?php $options->adminUrl('media.php?cid='); ?>${data.cid}" class="attachment save-ready selected details"><div class="attachment-preview js--select-attachment type-image subtype-jpeg landscape"><div class="thumbnail"><div class="centered"><img src="${url}" draggable="false" alt=""></div></div></div><button type="button" class="check" tabindex="-1"><span class="media-modal-icon"></span><span class="screen-reader-text">Deselect</span></button></li>`
                    ...
                    $(".attachments-wrapper .attachments li").unbind('click').bind('click', function (e) {
                        ...
                        window.cur_media_select_instance = $('.attachments-wrapper ul li').eq(0);
                    })
                     //默认选择第一个
                    $('.attachments-wrapper .attachments li').eq(0).click();
                ...
                var uploader = new plupload.Uploader({
                    ...
                    init: {
                        ...
                        type: "POST",
                        async:true,
                        url: document.location.protocol+"/index.php/bsBackendAction",
                        data: {
                            "type": 'editmedia',
                            "media-cid":data[1].cid,
                        },
                        dateType: "json",
