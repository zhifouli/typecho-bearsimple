        ...
        public static function get_enqueue_style($header = null)
        {
            ...
            if ($loads_statics) { // if is plugin
                ...
                $style = '<link rel="stylesheet" href="//lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/5.15.4/css/all.min.css?ver=5.15.4">' .
                    ...
                    '<link rel="stylesheet" href="' . self::include_plugin_url2('assets/css/style.min.css') . '">'.
                    '<link rel="stylesheet" href="' . self::include_plugin_url2('assets/css/color-picker.min.css') . '">'.
                    '<link href="//lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/fomantic-ui/2.8.8/semantic.min.css" rel="stylesheet">' .
...
margin-left:20px;
        ...
        public static function get_enqueue_script($old = null)
        {
            ...
            if ($loads_statics) { // if is plugin
                ...
                $script = '<script src="' . self::include_plugin_url2('assets/js/lodash.min.js') . '?v=2.2.4"></script>' .
                    '<script src="' . self::include_plugin_url2('assets/js/plugins.min.js') . '?v=2.2.4"></script>' .
                    '<script src="' . self::include_plugin_url2('assets/js/main.min.js') . '?v=2.2.4"></script>' .
                    '<script src="' . self::include_plugin_url2('assets/js/iris.min.js') . '?v=2.2.4"></script>' .
                    '<script src="//lf6-cdn-tos.bytecdntp.com/cdn/expire-1-M/jquery-tokeninput/1.7.0/jquery.tokeninput.min.js"></script>'.
                    '<script src="' . self::include_plugin_url2('assets/js/color-picker.min.js') . '?v=2.2.4"></script>' .
                    '<script src="' . self::include_plugin_url2('assets/js/jquery/ui/core.min.js') . '?v=2.2.4"></script>' .
                    '<script src="' . self::include_plugin_url2('assets/js/jquery/ui/draggable.min.js') . '?v=2.2.4"></script>' .
                    '<script src="' . self::include_plugin_url2('assets/js/jquery/ui/mouse.min.js') . '?v=2.2.4"></script>' .
                    '<script src="' . self::include_plugin_url2('assets/js/jquery/ui/menu.min.js') . '?v=2.2.4"></script>' .
                    '<script src="//lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/toastr.js/2.1.4/toastr.min.js?v=2.2.4"></script>'.
                    '<script src="' . self::include_plugin_url2('assets/js/backend.js') . '?v=2.9.8"></script>'.
                    '<script src="' . self::include_plugin_url2('assets/js/uuidv4.min.js') . '?v=2.2.4"></script>'.
                    '<script src="' . self::include_plugin_url2('assets/js/IndexNowViewScript.js') . '?v=2.2.4"></script>'.
...
//      $directory_uri  = set_url_scheme( $directory_uri, $protocol_uri );
        ...
        public static function include_plugin_url2($file)
        {
          
            return Helper::options()->siteUrl.'usr/plugins/BsCore/'.$file;
        }
